...
description: "Generate professional favicon suites (ICO/SVG/PNG) with layered effects; use when users ask for favicons, app icons, or browser tab icons."
metadata:
...
## Running the Bundled Tools (Codex)

This skill ships an interactive generator and a CLI under `scripts/`. When running commands, treat `<skill-dir>` as the folder containing this `SKILL.md` (Codex provides the skill file path at runtime).

```bash
# CLI example (run from your project root)
python <skill-dir>/scripts/generate_favicon.py --lucide rocket --style vibrant --output ./public/
```

Open the interactive generator in a browser:
- `<skill-dir>/scripts/generate_favicon.html`
...
**File**: `scripts/generate_favicon.html`
...
```bash
# Using a template
python <skill-dir>/scripts/generate_favicon.py --letter A --style vibrant --output ./public/

# Custom colors
python <skill-dir>/scripts/generate_favicon.py --letter T --bg "#22c55e" --bg2 "#14b8a6" --output ./favicons/

# Full control
python <skill-dir>/scripts/generate_favicon.py --letter N --bg "#0f172a" --fg "#22d3ee" \
...
5. [Generates with Python script]
   python <skill-dir>/scripts/generate_favicon.py --lucide package-plus --style modern --output ./public/
...
```bash
# Basic
python <skill-dir>/scripts/generate_favicon.py --letter A --output ./public/

# With template
python <skill-dir>/scripts/generate_favicon.py --letter T --style vibrant --output ./public/

# Custom colors
python <skill-dir>/scripts/generate_favicon.py --letter N --bg "#0f172a" --bg2 "#1e293b" \
  --fg "#22d3ee" --output ./public/

# Full control
python <skill-dir>/scripts/generate_favicon.py --letter M \
